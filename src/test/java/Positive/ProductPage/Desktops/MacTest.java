package Positive.ProductPage.Desktops;
...
public class MacTest extends BaseTest {
    ...
    public Object[][] excelDP() {
        Object[][] arrayData = getExcelData("src/main/resources/Products.xlsx", "Desktops");
        return arrayData;
    }
    ...
    public void AddToCartAndBuy(String name, String id, int select_payment_address, int select_shipping_address) throws InterruptedException {
        ...
        sectionGoods.linkToDesktops()
                    .linkToShowAllDesktops();

package Positive.ProductPage.LaptopsAndNotebooks;
...
public class ShowAllLaptopsAndNotebooksTest extends BaseTest {

    @DataProvider(name = "excelBD")
    public Object[][] excelDP() {
        Object[][] arrayData = getExcelData("src/main/resources/Products.xlsx", "LaptopsAndNotebooks");
        return arrayData;
    }
    ...
    public void AddToCartAndBuy(String name, String id, int select_payment_address, int select_shipping_address) throws InterruptedException {
        ...
        sectionGoods.linkToLaptopsAndNotebooks()
                    .linkToShowAllLaptopsAndNotebooks();
        productCategoryPage.linkToProductPage(name);
    ...
    @Test(dataProvider = "excelBD")
    public void AddToWishListAndRemove(String name, String id) {
        System.out.println(name);
        sectionGoods.linkToLaptopsAndNotebooks()
                    .linkToShowAllLaptopsAndNotebooks();
        productCategoryPage.linkToProductPage(name);
    ...
    public void CompareThisProductAndBuy(String name, String id, int select_payment_address, int select_shipping_address) throws InterruptedException {
        ...
        sectionGoods.linkToLaptopsAndNotebooks()
                    .linkToShowAllLaptopsAndNotebooks();
        productCategoryPage.linkToProductPage(name);
        productPage.CompareThisProduct()
                   .linkToComparePage();
    ...
    @Description(value = "Select the product, add it to the comparison and then buy")
    @Test(dataProvider = "excelBD")
    public void CompareThisProductAndRemove(String name, String id) {
        System.out.println(name);
        sectionGoods.linkToLaptopsAndNotebooks()
                    .linkToShowAllLaptopsAndNotebooks();
        productCategoryPage.linkToProductPage(name);
